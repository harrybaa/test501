function Slide(){
  ...
  this.buttonPre = {};
  this.buttonNext = {};
  this.sliderWidth = 0; //获取幻灯片外部div宽度
  this.sliderHeight = 0; //获取幻灯片外部div高度
  this.itemWidth = 0; //获取幻灯片Li的宽度
  this.itemNumber = 0; //获取幻灯片Li的数量
