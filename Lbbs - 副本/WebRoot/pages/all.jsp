...
<div align="center">
	...
	<div id="menu" >
		<table background="/images/index/indexS.jpg" width="800" height="38px">
			<tr>
				...
				<td width="11%"><a href="able.action">进入后台</a></td>
	...
	<div id="class">
		<table width="800px" height="30px" background="images/index/indexS.jpg">
			<tr>
				<td><s:a href="classify?bbs.boardId=21"><div id="class">Java技术</div></s:a></td>
				<td><s:a href="classify?bbs.boardId=22"><div id="class">C++技术讨论区</div></s:a></td>
