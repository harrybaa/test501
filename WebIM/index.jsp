...
<html>
  <head>
    ...
    <script type="text/javascript">
        window.contextPath = "<%=path%>";  //设置你链接openfire的地址
        window["serverDomin"] = "192.168.1.111";
    </script>
  ...
  <body>
    ...
    <form name="userForm" style="background-color: #fcfcfc; width: 100%;">
        ...
        sendTo： <input type="text" id="to" name="to" value="admin" width="10"/>
        <input type="button" value="Login" id="login"/> 
    </form>
    <!-- 新窗口聊天 -->
    <div id="newConn" style="display: none; background-color: #fcfcfc; width: 100%;">
           User：<label></label>
           sendTo： <input type="text" id="sendTo" value="admin" width="10"/>
